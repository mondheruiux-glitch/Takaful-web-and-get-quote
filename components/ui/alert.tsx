...
const alertVariants = cva("relative rounded-lg border", {
  variants: {
    variant: {
      ...
      destructive: "border-red-500/50 text-red-600 dark:border-red-500/50 dark:text-red-500", // mapped for shadcn compatibility
    },
    size: {
      sm: "px-4 py-3",
      lg: "p-4",
...
const Alert = React.forwardRef<HTMLDivElement, AlertProps>(
  (
    ...
    // Map destructive variant to error if not explicitly handled
    const resolvedVariant = variant === "destructive" ? "error" : variant;
    ...
    return (
      <div
        ...
        role="alert"
        className={cn(
          alertVariants({ variant: resolvedVariant, size, isNotification }),
          className,
        )}
        {...props}
      >
