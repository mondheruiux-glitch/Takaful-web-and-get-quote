...
const ExternalLinkIcon: React.FC<SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-4 h-4 opacity-70 group-hover:opacity-100 transition-opacity" {...props}>
...
const SlackIcon: React.FC<SVGProps<SVGSVGElement>> = (props) => (
  <svg viewBox="0 0 24 24" fill="currentColor" {...props}>
    <path d="M5.042 15.165a2.528 2.528 0 0 1-2.52 2.523 2.528 2.528 0 0 1-2.522-2.523 2.528 2.528 0 0 1 2.522-2.52h2.52v2.52zm1.261 0a2.528 2.528 0 0 1 2.52-2.52h5.043a2.528 2.528 0 0 1 2.522 2.52v5.043a2.528 2.528 0 0 1-2.522 2.52H8.824a2.528 2.528 0 0 1-2.52-2.52v-5.043zm0-6.341a2.528 2.528 0 0 1 2.52-2.522 2.528 2.528 0 0 1 2.522 2.522v2.52h-2.522a2.528 2.528 0 0 1-2.52-2.52zm0 1.261a2.528 2.528 0 0 1 2.52-2.52v-5.043A2.528 2.528 0 0 1 11.346 0h5.043a2.528 2.528 0 0 1 2.52 2.522v5.043a2.528 2.528 0 0 1-2.52 2.52H8.824a2.528 2.528 0 0 1-2.52-2.52zm12.654 3.757a2.528 2.528 0 0 1 2.52-2.52 2.528 2.528 0 0 1 2.522 2.52 2.528 2.528 0 0 1-2.522 2.52h-2.52v-2.52zm-1.261 0a2.528 2.528 0 0 1-2.52 2.52h-5.043a2.528 2.528 0 0 1-2.522-2.52v-5.043a2.528 2.528 0 0 1 2.522-2.52h5.043a2.528 2.528 0 0 1 2.52 2.52v5.043zm0 6.341a2.528 2.528 0 0 1-2.52 2.522 2.528 2.528 0 0 1-2.522-2.522v-2.52h2.522a2.528 2.528 0 0 1 2.52 2.52zm0-1.261a2.528 2.528 0 0 1-2.52 2.52v5.043a2.528 2.528 0 0 1-2.522 2.52h-5.043a2.528 2.528 0 0 1-2.52-2.522V8.824a2.528 2.528 0 0 1 2.52-2.52h5.043a2.528 2.528 0 0 1 2.52 2.52v5.043z"/>
  </svg>
);

// Teams Icon (SVG)
const TeamsIcon: React.FC<SVGProps<SVGSVGElement>> = (props) => (
  <svg viewBox="0 0 24 24" fill="currentColor" {...props}>
    <path d="M11.625 9.75c1.448 0 2.625-1.177 2.625-2.625S13.073 4.5 11.625 4.5 9 5.677 9 7.125s1.177 2.625 2.625 2.625zm0 1.5c-2.33 0-7.125 1.17-7.125 3.5v1.875h14.25V14.75c0-2.33-4.795-3.5-7.125-3.5z"/>
    <path d="M18.375 8.625c1.036 0 1.875-.839 1.875-1.875s-.839-1.875-1.875-1.875c-1.036 0-1.875.839-1.875 1.875s.839 1.875 1.875 1.875zm0 1.125c-.278 0-.585.034-.908.098.81.656 1.408 1.564 1.673 2.652H22.5V11.25c0-1.628-3.075-2.5-4.125-2.5z"/>
  </svg>
);
...
// Message Chat Icon (Web Chat)
const ChatIcon: React.FC<SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M8.625 12a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Zm0 0H8.25m4.125 0a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Zm0 0H12m4.125 0a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Zm0 0h-.375M21 12c0 4.556-4.03 8.25-9 8.25a9.764 9.764 0 0 1-2.555-.337A5.972 5.972 0 0 1 5.41 20.97a.75.75 0 0 1-1.074-.765 11.995 11.995 0 0 0 1.928-2.993C3.822 15.68 3 13.93 3 12c0-4.556 4.03-8.25 9-8.25s9 3.694 9 8.25Z" />
  </svg>
);
...
// Code/Terminal Icon (API Reference)
...
// Blog / News Icon (Blog)
const BlogIcon: React.FC<SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
   ...
   <AnimatePresence>
     {isOpen && (
       <motion.div
         ...
         className="absolute top-full left-1/2 transform -translate-x-1/2 mt-2 w-64 origin-top z-40"
       >
           <div className="bg-[#111111]/95 backdrop-blur-md border border-gray-800/80 rounded-lg shadow-2xl p-1.5">
               {children}
           </div>
       </motion.div>
     )}
...
const DropdownItem: React.FC<DropdownItemProps> = ({ href = "#", children, icon, rightIcon }) => (
  <a
    href={href}
    className="group relative flex items-center w-full px-3 py-2.5 text-sm text-gray-400 hover:text-white rounded-md transition-all duration-200 hover:bg-white/[0.04] overflow-hidden"
  >
    {/* Left accent indicator (indicates previewed selection on hover) */}
    <span className="absolute left-0 top-1/2 -translate-y-1/2 w-[3px] h-0 bg-[#0CF2A0] transition-all duration-250 ease-out group-hover:h-3/5 rounded-r-full" />
    
    <div className="flex items-center w-full pl-1.5 transition-transform duration-200 ease-out group-hover:translate-x-1">
      {icon && (
        <span className="w-4 h-4 mr-3 text-gray-500 group-hover:text-[#0CF2A0] transition-colors duration-200 flex items-center justify-center">
          {icon}
        </span>
      )}
      <span className="font-medium flex-grow">{children}</span>
      {rightIcon && (
        <span className="w-3.5 h-3.5 ml-2 text-gray-600 group-hover:text-gray-400 transition-colors duration-200 flex items-center justify-center">
          {rightIcon}
        </span>
      )}
    </div>
                ...
                <div className="hidden md:flex items-center justify-center flex-grow space-x-6 lg:space-x-8 px-4">
                    ...
                    >
                        ...
                        <DropdownMenu isOpen={openDropdown === 'channels'}>
                            <DropdownItem href="#" icon={<SlackIcon className="w-4 h-4" />}>Slack</DropdownItem>
                            <DropdownItem href="#" icon={<TeamsIcon className="w-4 h-4" />}>Microsoft Teams</DropdownItem>
                            <DropdownItem href="#" icon={<DiscordIcon className="w-4 h-4" />}>Discord</DropdownItem>
                            <DropdownItem href="#" icon={<MailIcon className="w-4 h-4" />}>Email</DropdownItem>
                            <DropdownItem href="#" icon={<ChatIcon className="w-4 h-4" />}>Web Chat</DropdownItem>
                        </DropdownMenu>
                    </div>
                    ...
                    >
                        ...
                        <DropdownMenu isOpen={openDropdown === 'resources'}>
                            <DropdownItem href="#" icon={<BlogIcon className="w-4 h-4" />} rightIcon={<ExternalLinkIcon />}>Blog</DropdownItem>
                            <DropdownItem href="#" icon={<BookIcon className="w-4 h-4" />}>Guides</DropdownItem>
                            <DropdownItem href="#" icon={<HelpIcon className="w-4 h-4" />}>Help Center</DropdownItem>
                            <DropdownItem href="#" icon={<TerminalIcon className="w-4 h-4" />}>API Reference</DropdownItem>
                        </DropdownMenu>
                    </div>
